...
function [rec,rec_lens] = ER_reconstruction_Fraunhoffer(x1,y1,Iterations,initial_field,initial_diffraction,initial_lens_field,initial_lens_diffraction,support_pad,paddingx,paddingy,am_p,am_p_lens,vecX,ncX_big,vecY,ncY_big,ph_p,ph_p_lens)
