...
[mask_lens,RfacR_lens,RfacF_lens,rec_lens]= OSS_lenscode4(F2D_lens,supp,iter,beta,showim,lens_modelimg,hiofirst,initial_lens_diffraction);  
%% 显示重建结果以及重建时间
reconstructionTime = toc;
reconstructionTime = round(10*reconstructionTime)./10;
fprintf('KCDI_OSS 弗朗禾费: Reconstruction completed in %.12g seconds.\n\n',reconstructionTime);
