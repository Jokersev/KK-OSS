...
function [rec,rec_lens] = reconstruction_obj6_convergence2_TF(x1,y1,Iterations,initial_field,initial_diffraction,initial_lens_field,initial_lens_diffraction,support_pad,paddingx,paddingy,L1,lambda,z2,am_p,am_p_lens,vecX,ncX_big,vecY,ncY_big,ph_p,ph_p_lens)
...
for iterationNum = 1:Iterations 
    %透镜衍射重建
    [initial_lens_field]= lens_Fresnelrealspace_TF(diffraction_lens_update,support_pad,paddingx,paddingy,L1,lambda,z2,iterationNum);
    [diffraction_lens_update]= lens_Fresnelspace_TF(initial_lens_field,L1,lambda,z2,am_p_lens,vecX,ncX_big,vecY,ncY_big,iterationNum);
