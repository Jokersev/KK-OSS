% OSS Source code:修改误差曲线，没有使用滤波器的最佳重建和交互选择

% function [mask RfacR RfacF RFD]= OSS_samplecode (F2D,supp,iter,beta,showim,modelimg,hiofirst) 
function [mask,RfacR,RfacF,sample]= OSS_samplecode_TF2(F2D,supp,iter,beta,showim,modelimg,hiofirst,L,lambda,z,k_space) 
