% OSS Source code:修改误差曲线，是否在过程中使用了滤波器和交互选择

% function [mask RfacR RfacF RFD]= OSS_samplecode (F2D,supp,iter,beta,showim,modelimg,hiofirst) 
function [mask,RfacR,RfacF,sample]= OSS_samplecode_TF3(F2D,supp,iter,beta,showim,modelimg,hiofirst,L,lambda,z,k_space) 
